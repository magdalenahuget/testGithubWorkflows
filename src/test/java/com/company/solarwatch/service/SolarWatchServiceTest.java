...
class SolarWatchServiceTest2 {
    ...
    void testGetSolarWatchReportSuccess() throws JsonProcessingException {
        ...
        // WHEN
        when(solarWatchService.getApiKey()).thenReturn(geoApiKey);
        when(solarWatchService.getOpenGeoReportsFromApi(geoApiUrl)).thenReturn(openGeoReports);
        when(solarWatchService.getOpenSolarWatchReportFromApi(solarApiUrl)).thenReturn(openSolarWatchReport);
    ...
    private static String getOtherCityNames() {
        return "{\n" +
                "            \"te\": \"పారిస్\",\n" +
                "            \"af\": \"Parys\",\n" +
                "            \"fr\": \"Paris\",\n" +
    ...
    void testGetSolarWatchReportCityNotFoundException() {
        ...
        when(solarWatchService.getOpenGeoReportsFromApi(geoApiUrl)).thenReturn(null);
